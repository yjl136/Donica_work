...
//        IconUtil.init(mContext);
        ...
        //viewHolder.mAppIcon.setImageBitmap(TailorUtil.getCircleBitmap(Utilities.createIconBitmap(appInfo.loadIcon(pm), mContext)));


        //  viewHolder.mAppIcon.setBackground(appInfo.loadIcon(pm));
        // viewHolder.mAppIcon.setBackground(BaseApplication.getContext().getResources().getDrawable(R.drawable.ico_kiora));


        //   viewHolder.mAppIcon.setImageBitmap(IconUtil.getBitmapWithNoScale(BaseApplication.getContext().getResources().getDrawable(R.drawable.background), Utilities.drawable2Bitmap(appInfo.loadIcon(pm))));
        // viewHolder.mAppName.setText(appInfo.loadLabel(pm));
        return convertView;
    }
